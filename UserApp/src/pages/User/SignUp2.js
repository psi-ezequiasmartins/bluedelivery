...
import { SafeAreaView, View, Image, Text, TextInput, TouchableOpacity, KeyboardAvoidingView, Platform, ActivityIndicator, StyleSheet, ScrollView, Keyboard } from 'react-native';
    ...
    <SafeAreaView style={styles.background}>
      <View style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : ''} enabled>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Informe seu telefone, email, e defina uma senha com 6 números.</Text>
        </View>
        ...
        >
          ...
          >
            ...
            <View style={styles.areaInput}>
              <Text style={{marginBottom: 5}}>Confirme sua Senha:</Text>
              <TextInput
