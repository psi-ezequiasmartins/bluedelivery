/**
 * src/components/gps/AddressConfirmationDialog.js
 */
...
export function AddressConfirmationModal({ visible, address, onConfirm, onCancel }) {
  ...
  // Atualizar o endereço editado quando o address prop mudar
  React.useEffect(() => {
      ...
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          ...
          <TextInput
            ...
            multiline
            numberOfLines={2}
            placeholder="Endereço completo: Rua/Av, Nº, Complemento, etc."
          />
