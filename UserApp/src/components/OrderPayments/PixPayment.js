/**
 * src/components/OrderPayments/PixPayment.js
 */
    ...
    if (pixData) {
      const checkStatus = setInterval(async () => {
        try {
          ...
          // Ignora erros de consulta de status PIX para evitar logs desnecessários
          console.log('PIX status check - aguardando transação...');
        }
