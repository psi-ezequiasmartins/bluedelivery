...
--
-- Host: localhost
-- Generation Time: Sep 29, 2025 at 10:53 AM
...
INSERT INTO `categorias` (`CATEGORIA_ID`, `CATEGORIA_NOME`, `URL_IMAGEM`, `ORDEM`) VALUES
(101, 'OFERTAS', 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/categorias%2Fofertas.jpg?alt=media&token=09be1bc9-e1e6-4bfd-96bc-7ddde99f6ca8', 1),
(102, 'SANDUICHES', 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/categorias%2Fsanduiches.jpg?alt=media&token=6d5ec164-14f1-4155-b811-68c06817dcf9', 2),
(103, 'HOTDOGS', 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/categorias%2Fhotdogs.jpg?alt=media&token=3b5e2cfb-6c14-473e-839c-77d7f2bbc603', 3),
(104, 'BEBIDAS', 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/categorias%2Fbebidas.jpg?alt=media&token=483261bf-e614-4595-be00-f28960b76b08', 4),
(105, 'PRATOS & PORÇÕES', 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/categorias%2Fpratos-e-porcoes.jpg?alt=media&token=5674c103-599a-4d25-b2ae-67112421d727', 5),
(106, 'SUSHI', 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/categorias%2Fsushi.jpg?alt=media&token=2714e481-e100-4032-aca3-5507cdabab10', 6),
(107, 'FRUTAS & VERDURAS', 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/categorias%2Ffrutas-e-verduras.jpg?alt=media&token=96b9fc23-3d36-4a54-be07-efe3c1de0577', 7),
(108, 'MEDICAMENTOS', 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/categorias%2Ffarmarcias-e-drograrias.jpg?alt=media&token=9980f634-d422-4584-a145-c72f13a7e5af', 8),
(109, 'GÁS DE COZINHA', 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/categorias%2Fgas-de-cozinha.jpg?alt=media&token=30cc52d5-2aed-4793-afd9-3285b85d733f', 9),
(110, 'FLORICULTURA', 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/categorias%2Ffloricultura.jpg?alt=media&token=25adf89e-4424-4d1e-b936-5b7101f4c8e8', 10),
(111, 'ÁGUA MINERAL', 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/categorias%2Fagua-mineral.jpg?alt=media&token=54dae688-bde6-4bd4-9203-cb9b13bbeea6', 11),
(112, 'MERCADO', 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/categorias%2Fsupermercado.jpg?alt=media&token=ae6f286a-8eec-4f67-87c8-9e4a3051882d', 12);
...
CREATE TABLE `couriers` (
  ...
  `URL_IMAGEM` varchar(240) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `TOKEN_MSG` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `couriers` (`COURIER_ID`, `NOME`, `SOBRENOME`, `CPF`, `TELEFONE`, `EMAIL`, `ENDERECO`, `NUMERO`, `COMPLEMENTO`, `BAIRRO`, `CIDADE`, `UF`, `CEP`, `TRANSPORTE`, `URL_IMAGEM`, `TOKEN_MSG`) VALUES
...
CREATE TABLE `deliveries` (
  ...
  `PUSH_TOKEN` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `deliveries` (`DELIVERY_ID`, `DELIVERY_NOME`, `PLANO`, `SITUACAO`, `CATEGORIA_ID`, `RESPONSAVEL`, `EMAIL`, `TELEFONE`, `HORARIO`, `MIN_DELIVERY_TIME`, `MAX_DELIVERY_TIME`, `TAXA_ENTREGA`, `RATING`, `URL_IMAGEM`, `CEP`, `ENDERECO`, `NUMERO`, `COMPLEMENTO`, `BAIRRO`, `CIDADE`, `UF`, `PUSH_TOKEN`) VALUES
(1001, 'Cantin d\'Minas Delivery', 'PRO', b'1', 105, 'José Antônio de Oliveira e Cida', 'joseantoniodeoliveira71@gmail.com', '+55 31 98775-9781', 'Aberto das 9h até às 19h de Segunda a Sábado', 15, 30, 4.5, 4.9, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/deliverys%2Fcantindminasdelivery.jpg?alt=media&token=a6259473-4eb1-4f0e-98ce-251b151bab9f', '', 'Rua Antônio Junqueira Júnior, 77 Santa Mônica, Belo Horizonte, MG, 31530-390', '', '', '', '', '', ''),
(1002, 'Sanduba do Zé', 'PREMIUM', b'1', 102, 'Zé das Couves', 'zedascouves@email.com', '+55 31 98410-7540', 'Aberto todos os dias a partir das 19h exceto às segundas feiras (fechado)', 15, 45, 4, 3.5, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/deliverys%2Fsandubadoze.jpg?alt=media&token=3bac7899-904e-4acd-aac8-75506a1d6819', '31525-365', 'Rua Érico Veríssimo', '2267', 'Loja B', 'Santa Mônica', 'Belo Horizonte', 'MG', ''),
(1003, 'Hotdog da Maria', 'PRO', b'1', 103, 'Maria das Graças ', 'mariadg@email.com', '+55 31 9999-9999', 'Aberto a partir das 19h', 15, 30, 3.5, 4.7, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/deliverys%2Fhotdogdamaria.jpg?alt=media&token=93d46c8d-abe3-4008-aa2d-c9a81a6c23fb', '', 'Rua dos Bororós, 629 Santa Mônica, Belo Horizonte, MG, ', '', '', '', '', '', ''),
(1004, 'Distribuidora Guarani', 'PRO', b'1', 104, 'José Carlos dos Santos', 'josecarlosdossantos@gmail.com', '+55 31 98651-1043', 'Aberto das 9 às 19hs, de segunda a sábado', 15, 30, 3.9, 3.9, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/deliverys%2Fdistribuidoraguarani.jpg?alt=media&token=4ed12a92-f1cb-4d28-a7fe-3a4317a8063e', '', 'Rua Jornalista Laércio Campos, 97 Lj A Guarani, Belo Horizonte, MG, 31814-390', '', '', '', '', '', ''),
(1005, 'Espetinhos da Dinda', 'PRO', b'1', NULL, 'Cláudio Silva', 'espetinhosdadinda@gmail.com', NULL, 'Terça a Domingo, das 19h às 23h', NULL, NULL, NULL, NULL, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2Fespetinhos-da-dinha.jpg?alt=media&token=5cc3520b-dbef-41d3-825f-77e50c216e82', '31160-190', 'Rua Jacuí ', '3930', 'Loja B', 'Ipiranga', 'Belo Horizonte', 'MG', NULL),
(1007, 'Churrascaria do Boi', 'FREE', b'1', 1, '', 'churrascariadoboi@gmail.com', '', '', 0, 0, 0, 0, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2Fchurrascaria-do-boi.jpg?alt=media&token=806e896b-fb0b-48cf-ad00-6c636b5a583a', '', '', '', '', '', '', '', '');
...
INSERT INTO `favorecidos` (`ID`, `FAVORECIDO`, `CNPJ`, `CPF`) VALUES
(1, '   ', '', ''),
(2, 'MARCO AURÉLIO BRACARENSE', '03.025.474/0001-86', ''),
(3, 'ARTE DE LIMPAR LTDA', '', ''),
(5, 'ELEVADORES OTIS S/A', '', ''),
(6, 'COPASA-MG COMPANIA DE SANEAMENTO DE MINAS GER', '17.811.106/0001-03', ''),
(7, 'CEMIG - CENTRAIS ELÉTRICAS DE MINAS GERAIS', '06.981.180/0001-16', ''),
(8, 'EZEQUIAS MARTINS DA COSTA BARBOSA', '18.478.810/0001-13', '732.093.416-72'),
(9, 'CONDOMÍNIO DO EDIFÍCIO BAHIA', '', '');
...
(7, '1083', 35.10, 'GENERATED', 'PSI00001083', '00020126470014br.gov.bcb.pix0125ezequiasmartins@gmail.com520400005303986540535.105802BR5912PSI-SOFTWARE6015BELO HORIZONTE 62150511PSI0000108363048BAB', '2025-09-24 21:39:48', '2025-09-24 21:39:48'),
(8, '1084', 51.99, 'GENERATED', 'PSI00001084', '00020126470014br.gov.bcb.pix0125ezequiasmartins@gmail.com520400005303986540551.995802BR5912PSI-SOFTWARE6015BELO HORIZONTE 62150511PSI0000108463049E26', '2025-09-25 21:10:59', '2025-09-25 21:11:00'),
(9, '1085', 69.40, 'GENERATED', 'PSI00001085', '00020126470014br.gov.bcb.pix0125ezequiasmartins@gmail.com520400005303986540569.405802BR5912PSI-SOFTWARE6015BELO HORIZONTE 62150511PSI000010856304F4F5', '2025-09-26 15:43:16', '2025-09-26 15:43:16');
...
CREATE TABLE `produtos` (
  ...
  `VR_UNITARIO` float(9,2) DEFAULT NULL,
  `URL_IMAGEM` varchar(240) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `ITENS_EXTRAS` varchar(1) NOT NULL,
  `ITENS_OBS` varchar(1) NOT NULL,
  `DELIVERY_ID` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `produtos` (`PRODUTO_ID`, `PRODUTO_NOME`, `DESCRICAO`, `VR_UNITARIO`, `URL_IMAGEM`, `ITENS_EXTRAS`, `ITENS_OBS`, `DELIVERY_ID`) VALUES
(1017, 'X-Tudo', 'Pão, hambúrguer de carne angus, alface, tomate e queijo prato.', 33.90, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2Fx-cebola-maionese.jpg?alt=media&token=5c279940-5b42-4107-8467-5462189b367b', 'S', 'S', 1002),
(1018, 'X-Egg Bacon', 'Pão, hambúrguer de carne angus, creme cheese, queijo prato, bacon e ovo.', 24.90, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2Fx-eggbacon.jpg?alt=media&token=c4dfa87f-d48c-4559-8f1b-accf16512b28', 'S', 'S', 1002),
(1019, 'X-Bacon Duplo', 'Pão, 02 hambúrguers de carne angus, salada, queijo prato e bacon.', 27.90, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2Fxbacon-duplo.jpg?alt=media&token=48f0e6a0-8536-497b-8803-bea76992a583', 'S', 'S', 1002),
(1020, 'X-Filé Frango', 'Pão, filet de frango picado, creme cheese e queijo prato.', 25.60, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2Fx-frango.png?alt=media&token=4c7f5bfa-dcd8-4bed-a5db-6e982a0c7ea5', 'S', 'S', 1002),
(1022, 'Hot Dog Tradicional', 'Pão de Hot Dog, 1 Salsicha, Ketchup, Maionese e Mostarda', 14.50, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2Fhotdog-1.png?alt=media&token=63055b8f-b826-4f23-9348-0649a92c0738', 'N', 'S', 1003),
(1023, 'Hot Dog Soja', 'Salsicha de soja, requeijão, oregano, cheddar, vinagrete, milho, maionese, batata palha, pure e parmesão (vegetariano ou vegano)', 28.00, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2Fhotdog-2.png?alt=media&token=a4556ff9-6e61-465e-9a1a-3482cea3e6e0', 'N', 'S', 1003),
(1024, 'Hot Dogão', 'Duas salsichas, requeijão, oregano, cheddar, vinagrete, milho, maionese, batata palha, pure e parmesão', 31.00, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2Fhotdog-3.png?alt=media&token=00a92e27-fa0e-4ff8-b359-d87e3d5912d6', 'N', 'S', 1003),
(1025, 'Coca-Cola Lata', 'Refrigerante Coca-Cola lata 350ml', 4.80, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2Fcoca-cola.jpg?alt=media&token=55f1a7a2-8550-4d42-80f5-b6331e593462', 'N', 'N', 1002),
(1030, 'Porção de Fritas + Frango a Passarinho', '300g de Batata Frita a Palito + 300g de Frango Frito a Passarinho + Salada (opcional)', 45.00, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2Ffrango%20a%20passarinho%20%2B%20fritas.jpg?alt=media&token=b56f9fb2-0cd8-4d16-9af3-22a2bd9c4912', 'S', 'S', 1001),
(1032, 'Porção de Frango a Passarinho', '600g de Frango Frito a Passarinho + Salada Americana (opcional)', 38.00, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2Ffrango%20a%20passarinho.jpg?alt=media&token=8b81e72c-2657-49e2-8c71-12052282fced', 'S', 'S', 1001),
(1039, 'Mexidão', 'Arroz, feijão, farofa c/ ovos mexido, calabresa acebolada, ovo frito, bacon', 15.00, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2Fmexid%C3%A3o.png?alt=media&token=d2794d1a-367a-42d6-89df-1b10d0ec37e8', 'S', 'S', 1001),
(1040, 'Espaguete a Bolonhesa', 'Espaguete ao molho Bolonhesa c/ Mussarella', 18.00, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2Fespaguete-bolonhesa.png?alt=media&token=665e0aa5-9619-4acc-a8c4-b84194760ff4', 'S', 'S', 1001),
(1041, 'Janta', 'A escolha, pernil, frango, omelete, arroz feijão espaguete fritas', 15.00, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2Fjanta.png?alt=media&token=e74ef0b5-8875-4f7f-abd6-34efddb9358e', 'S', 'S', 1001),
(1048, 'Guaraná Antárctica Lata', 'Refrigerante de Guaraná, Lata 350ml', 4.50, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2Fguaran%C3%A1%20antarctica.jpg?alt=media&token=96b03d8a-3b04-4eb6-8329-6c3844ccc2cd', 'N', 'N', 1002),
(1053, 'Guaraná Antártica 350ml', 'Refrigerante de Guaraná, Lata 350ml', 4.50, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2Frefri-2.png?alt=media&token=52f4e4fd-ea27-440e-ab70-4521ae1f8d7f', 'N', 'N', 1003),
(1054, 'Coca-Cola 350ml', 'Refrigerante de Cola, Lata 350ml', 4.50, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2FCOCA-COLA.jpg?alt=media&token=69426c3a-8702-482e-bbfe-8671bdd3ab56', 'N', 'N', 1003),
(1057, 'Água Mineral s/ Gás', 'Água Mineral sem Gás, copo 200ml', 2.00, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2F%C3%81GUA%20MINERAL%20SEM%20G%C3%81S%20200ML.jpg?alt=media&token=abc0d91a-ee07-4844-a4e1-a5cc29b07741', 'N', 'N', 1001),
(1058, 'Água Mineral c/ Gás', 'Água Mineral com Gás Natural, garrafa 300ml', 2.80, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2F%C3%81GUA%20MINERAL%20GASOSA.jpg?alt=media&token=fa672ffa-6fe3-4786-bbe8-80db63cf1dea', 'N', 'N', 1001),
(1061, 'Refrigerante Coca-Cola 350ml', 'Refrigerante de Cola, Lata 350ml', 4.80, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2FCOCA-COLA.jpg?alt=media&token=bb15e4ec-18d9-4439-861f-064a623394b6', 'N', 'N', 1001),
(1062, 'Refrigerante Guaraná Antártica 350ml', 'Refrigerante de Guaraná, Lata 350ml', 4.80, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2FGUARAN%C3%81%20ANTARCTICA%20350%20ML.jpg?alt=media&token=89db11b1-2ad1-4026-9913-1fda702d8ef3', 'N', 'N', 1001),
(1063, 'Cerveja Brahma 350ml', 'Cerveja Brahma Chopp Lata 350ml', 7.59, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2FCERVEJA%20BRAHMA%20LATA.jpg?alt=media&token=1ab1d965-a44b-4eae-8086-45bd20b07787', 'N', 'N', 1001),
(1064, 'Espetinho Carne de Boi + Bacon', 'Espetinho de churrasco, carne de Boi e Bacon', 14.99, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2Fespetinho-carne-boi-bacon.jpg?alt=media&token=90814bdb-9969-46e4-ae74-9db0f49b5c5a', 'S', 'S', 1005),
(1065, 'Espetinho Carne de Frango', 'Espetinho de churrasco, carne de Frango', 14.99, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2Fespetinho-carne-frango.jpg?alt=media&token=7b4a3cfa-1701-4576-9c5c-5665106d70c0', 'S', 'S', 1005),
(1066, 'Espetinho Carne de Porco', 'Espetinho de churrasco, carne de Porco', 12.99, 'https://firebasestorage.googleapis.com/v0/b/psi-crm-ca846.appspot.com/o/produtos%2Fespetinho-carne-porco.jpg?alt=media&token=e03dc6d2-049f-48c2-b6d9-d618749a0381', 'S', 'S', 1005),
(1068, 'Água Mineral Gasosa 300ml', 'Água Mineral c/ Gás Natural\nGarrafa c/ 300ml', 4.80, 'https://firebasestorage.googleapis.com/v0/b/psi-deliverybairro.firebasestorage.app/o/produtos%2F%C3%81GUA%20MINERAL%20GASOSA.jpg?alt=media&token=81e61c8b-19b8-4713-b079-2893a27d719b', 'S', 'S', 1002),
(1069, 'Cerveja Brahma Lata 355ml', 'Cerveja Brahma Chopp Lata 355ml', 7.99, 'https://firebasestorage.googleapis.com/v0/b/psi-deliverybairro.firebasestorage.app/o/produtos%2Fcerveja%20brahma.jpg?alt=media&token=293ae99f-d010-46cb-bc2d-fcca6a2e342c', 'N', 'N', 1002),
(1070, 'X-Burguer Gourmet', 'Carne de Hamburguer Especial 200gr Grelhado,\nAlface, Rúcula, Cebola Roxa, Tomate, Queijo Cheddar, Pão Especial', 35.00, 'https://firebasestorage.googleapis.com/v0/b/psi-deliverybairro.firebasestorage.app/o/produtos%2Fhamburguer-artezanal.jpg?alt=media&token=a2d0077f-f46a-49fd-bcda-c3709262fa78', 'S', 'S', 1002);
...
--
ALTER TABLE `extras`
  MODIFY `EXTRA_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `favorecidos`
--
ALTER TABLE `favorecidos`
...
--
ALTER TABLE `itens`
  MODIFY `ITEM_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;

--
-- AUTO_INCREMENT for table `pedidos`
--
ALTER TABLE `pedidos`
  MODIFY `PEDIDO_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1087;
